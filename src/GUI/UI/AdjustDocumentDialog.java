...
public class AdjustDocumentDialog extends AbstractDocumentDialog {
    ...
    public AdjustDocumentDialog(Document document, MainFrame mainFrame) {
        initGUI(document, mainFrame);
    }
    ...
    private void initGUI(Document document, MainFrame mainFrame) {
        setTitle("Dokument bearbeiten");
        setModal(true);
        ...
        assignedTagTableModel = new AssignedTagTableModel(this,document);
        ...
        JMenuItem assignedTagsDeleteMenuItem = new JMenuItem(new DeleteAssignedTagAction(assignedTagsTable, assignedTagTableModel, document));
        ...
        documentPathTextField.setText(document.getDocumentPath());
        add(documentPathTextField);

        DocumentDialogActionListener actionListener = new DocumentDialogActionListener(this, document);
        ...
        TableRowSorter<AllTagTableModel> allTagsSorter = new TableRowSorter<>(allTagTableModel);
        ...
        adjustButton.addActionListener(actionListener);
        adjustButton.setActionCommand(ADJUST_BUTTON);
        constraints = UIUtility.createConstraints(2,6,0,0,NONE);
        constraints.anchor = SOUTHEAST;
        layout.setConstraints(adjustButton, constraints);
        add(adjustButton);
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                AdjustDocumentDialog.this.dispose();
            }
        });
        pack();
